...
class DocumentService {
  ...
  static Future<Map<String, dynamic>> uploadIdentityCardForSubscription(
    ...
    try {
      debugPrint('📤 Début upload pièce d\'identité pour souscription $subscriptionId...');
      ...
      debugPrint('📊 Taille du fichier: ${(fileSize / 1024 / 1024).toStringAsFixed(2)} MB');

      final uri = Uri.parse('${AppConfig.baseUrl}/api/subscriptions/$subscriptionId/upload-document');
  ...
  static String getIdentityCardUrl(int subscriptionId, String filename) {
    ...
    if (!filename.startsWith('/')) {
      return '${AppConfig.baseUrl}/api/subscriptions/$subscriptionId/document/$filename';
    }
    ...
    if (filename.startsWith('/uploads/')) {
      ...
      return '${AppConfig.baseUrl}/api/subscriptions/$subscriptionId/document/$justFilename';
    }
  ...
  static String getPhotoUrl(String? photoUrl) {
    ...
    if (!photoUrl.startsWith('/')) {
      return '${AppConfig.baseUrl}/api/users/photo/$photoUrl';
    }
