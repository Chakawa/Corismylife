...
Ce contrat garantit, en cas de décès ou de Perte Totale et Irréversible d'Autonomie de l'assuré (PTIA), quelle que soit la date de survenance, le versement d'un capital dont le montant est défini à la souscription aux bénéficiaire(s) désigné(s). Ainsi, il permet de garantir durablement la sécurité financière et matérielle du conjoint, des enfants ou des proches en cas d'événements malheureux tout en constituant au fur et à mesure une épargne de prévoyance pour vous et une libre disposition en cas de nécessité.
...
**⚰️ En cas de décès ou de Perte Totale et Irréversible d'Autonomie**
