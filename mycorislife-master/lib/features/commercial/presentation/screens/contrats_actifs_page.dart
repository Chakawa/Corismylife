...
class _ContratsActifsPageState extends State<ContratsActifsPage> {
  ...
  Future<void> _loadContratsActifs() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('${AppConfig.baseUrl}/commercial/contrats_actifs'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          contratsActifs = data['contrats'] ?? [];
          isLoading = false;
        });
      } else {
        throw Exception('Erreur lors du chargement des contrats actifs');
      }
    } catch (e) {
      print('Erreur: $e');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Contrats Actifs'),
          ...
          : contratsActifs.isEmpty
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: contratsActifs.length,
                    itemBuilder: (context, index) {
                      final contrat = contratsActifs[index];
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text('Date: ${contrat['datesous'] ?? 'N/A'}'),
                            ],
                          ),
