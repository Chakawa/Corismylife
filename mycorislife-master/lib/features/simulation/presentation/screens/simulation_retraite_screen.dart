...
class _CorisRetraiteScreenState extends State<CorisRetraiteScreen> {
    ...
    try {
      ...
      if (tarifFromDB != null) {
        ...
        if (capital != null && prime != null) {
          print(
              '   âœ… Tarif RETRAITE trouvé en base (source: ${result['isFromServer'] ? 'serveur' : 'cache local'})');
      ...
      print(
          '   âš ï¸ Erreur lors de la récupération du tarif RETRAITE depuis la base: $e');
    }
    return null;
  }
  ...
  Future<double> calculatePremium(
    ...
    print('â•‘ ðŸ§® [RETRAITE] CALCUL PRIME DÉMARRÉ                           â•‘');
    print('â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•');
    print('   ðŸ“Š Paramètres:');
    print('      - Durée: $duration ans');
    print('      - Périodicité: $periodicity');
    print(
        '      - Capital souhaité: ${desiredCapital.toStringAsFixed(0)} FCFA');
    print(
        '   ðŸŒ Mode: ${_useLocalData ? "HORS LIGNE (données locales)" : "EN LIGNE"}');

    if (duration < 5 || duration > 50) {
      print('   âŒ ERREUR: Durée invalide ($duration ans)');
      showError(
    ...
    print('\n   ðŸ“ UTILISATION DES DONNÉES LOCALES (comme la souscription)');

    // Étape 2: Fallback - Utiliser les données codées en dur
    print(
        '\n   ðŸ“ ÉTAPE 2: Tentative utilisation FALLBACK (données hardcodées)...');
    ...
    if (hasHardcodedData) {
      ...
      print('   âœ… Données hardcodées disponibles');
      print(
      ...
      print('   ðŸ’° CALCUL (nouvelle méthode):');
      print(
      ...
      print(
          '\nâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—');
      print('â•‘ âš ï¸  [RETRAITE] CALCUL RÉUSSI (FALLBACK - données hardcodées) â•‘');
      print(
          'â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n');

      return primeCalculee;
    } else {
      print('   âŒ Données hardcodées NON disponibles');
      print(
      ...
      print('   âš ï¸  IMPOSSIBLE DE CALCULER: Aucune donnée disponible');
      print('      â†’ Ni base de données, ni données hardcodées');
      ...
      print(
          '\nâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—');
      print('â•‘ âŒ [RETRAITE] CALCUL ÉCHOUÉ                                   â•‘');
      print(
          'â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n');
  ...
  Future<double> calculateCapital(
    ...
    print(
        '\nâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—');
    print('â•‘ ðŸ§® [RETRAITE] CALCUL CAPITAL DÉMARRÉ                         â•‘');
    print('â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•');
    print('   ðŸ“Š Paramètres:');
    print('      - Durée: $duration ans');
    print('      - Périodicité: $periodicity');
    ...
    if (paidPremium < minPremium) {
      print('   âŒ ERREUR: Prime inférieure au minimum');
      showError(
    ...
    print(
        '\n   ðŸ“ UTILISATION DES DONNÉES LOCALES (même logique que la souscription)');
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  // Vérifier le rÃ´le et rediriger
