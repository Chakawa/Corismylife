...
class _FlexEmprunteurPageState extends State<FlexEmprunteurPage> {
  ...
  Future<double> _getRateFromDbOrFallback({
    ...
    print('\n╔═══════════════════════════════════════════════════════════════╗');
    print('║ 🔍 [FLEX EMPRUNTEUR] Recherche taux                          ║');
    print('╚═══════════════════════════════════════════════════════════════╝');
    print('   📊 Paramètres: age=$age, duree=$dureeMois mois, categorie=$categorie');
    ...
    try {
      ...
      if (tarifFromDB != null && tarifFromDB.prime != null) {
        ...
        if (categorie != null && tarifFromDB.categorie != categorie) {
          ...
          print('\n╔═══════════════════════════════════════════════════════════════╗');
          print('║ ✅ [FLEX EMPRUNTEUR] Données utilisées depuis SERVEUR        ║');
          print('╚═══════════════════════════════════════════════════════════════╝\n');
          return tarifFromDB.prime!;
        }
      } else {
        print('   ⚠️  Taux non trouvé dans la DB (serveur inaccessible ou données absentes)');
        print('   💡 Passage au fallback (données hardcodées)');
      }
    } catch (e) {
    ...
    if (tableFallback.containsKey(exactKey)) {
      ...
      print('\n╔═══════════════════════════════════════════════════════════════╗');
      print('║ ⚠️  [FLEX EMPRUNTEUR] Données utilisées depuis FALLBACK       ║');
      print('╚═══════════════════════════════════════════════════════════════╝\n');
      return taux;
    }

    // Recherche approximative dans le fallback
    final possibleKeys = tableFallback.keys.where((key) => key.startsWith('${age}_')).toList();
    ...
    final allAges = tableFallback.keys.map((key) => int.tryParse(key.split('_')[0]) ?? 0).toSet().toList();
    allAges.sort((a, b) => (a - age).abs().compareTo((b - age).abs()));
    
    if (allAges.isNotEmpty) {
      final closestAge = allAges.first;
      final closestAgeKeys = tableFallback.keys.where((key) => key.startsWith('${closestAge}_')).toList();
    ...
    print('\n╔═══════════════════════════════════════════════════════════════╗');
    print('║ ❌ [FLEX EMPRUNTEUR] ERREUR: Aucune donnée disponible        ║');
    print('╚═══════════════════════════════════════════════════════════════╝\n');
    return 0.0;
  }
  ...
  Future<double> _getRatePerteEmploiFromDbOrFallback({
    ...
    print('\n╔═══════════════════════════════════════════════════════════════╗');
    print('║ 🔍 [FLEX EMPRUNTEUR] Recherche taux Perte d\'Emploi           ║');
    print('╚═══════════════════════════════════════════════════════════════╝');
