...
export default function AdminDashboard() {
  ...
  // Les modérateurs ne voient que les activités récentes
  ...
  // Pour les admins et super admins
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        {monthlyData.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Évolution Mensuelle</h3>
        ...
        {productDistribution.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Distribution par Produit</h3>
            <ResponsiveContainer width="100%" height={280}>
              <PieChart>
                <Pie
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
        {monthlyData.length > 0 && (
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-3">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold text-gray-900">Revenus Mensuels (FCFA)</h3>
        ...
        {statusData.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Statut des Contrats</h3>
            <ResponsiveContainer width="100%" height={280}>
              <PieChart>
                <Pie
                  data={statusData}
